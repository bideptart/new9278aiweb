      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-2 rounded-full bg-rose-50/80 dark:bg-rose-950/30 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50 shadow-xs">
            <BadgeCheck className="size-3.5 text-rose-500" />
          ...
          <h2 className="text-balance text-3xl font-serif font-normal leading-tight md:text-5xl text-foreground">
            Financial AI sovereign <span className="italic text-rose-600 dark:text-rose-400">3D circuit grid.</span>
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 text-[10px] font-mono font-bold">
                  ...
                  <span className={isSelected ? "text-rose-600 dark:text-rose-400" : "text-muted-foreground"}>
                    NODE {nd.number}
                  </span>
                </div>
                ...
                <div
                  className={cn(
                    ...
                    isSelected
                      ? "bg-rose-500/15 text-rose-600 dark:text-rose-400 border-rose-300 dark:border-rose-800 scale-110 shadow-md"
          ...
          >
            ...
            <div className="lg:col-span-5 flex justify-center [perspective:1000px]">
              ...
              >
                ...
                <span
                  className="text-[10px] font-mono font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 bg-rose-500/10 px-3 py-0.5 rounded-full border border-rose-200 dark:border-rose-900/50"
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-mono font-bold text-rose-600 dark:text-rose-400 bg-rose-500/15 px-2.5 py-0.5 rounded-full border border-rose-200 dark:border-rose-900/50">
              ...
              <div className="space-y-3">
                {currentNode.highlights.map((item, i) => (
                  ...
                  >
                    <div className="size-6 rounded-full bg-rose-500/15 text-rose-600 dark:text-rose-400 flex items-center justify-center shrink-0 border border-rose-200 dark:border-rose-900/50">
