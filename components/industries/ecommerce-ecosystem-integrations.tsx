...
export function EcommerceEcosystemIntegrations() {
  ...
  return (
    <section className="relative mx-auto w-full max-w-6xl px-4 py-16 md:px-6 md:py-24 border-t border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 -z-10 size-[750px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-tr from-rose-500/10 via-amber-500/5 to-transparent blur-3xl opacity-60"
      />

      {/* SECTION 1: E-Commerce Integrations Ecosystem */}
      <div className="space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-2 rounded-full bg-rose-50/80 dark:bg-rose-950/30 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50 shadow-xs">
            <Zap className="size-3.5 text-rose-500 animate-pulse" />
          ...
          <h2 className="text-balance text-3xl font-serif font-normal tracking-tight md:text-5xl text-foreground leading-[1.1]">
            Plugs into your store in 3 minutes. <span className="italic text-rose-600 dark:text-rose-400">Zero code required.</span>
          </h2>
            ...
            {integrations.map((item, idx) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "px-3.5 py-2 rounded-full text-xs font-bold transition-all duration-300 flex items-center gap-2 cursor-pointer border shadow-xs backdrop-blur-md",
                    isSelected
                      ? "bg-rose-500/15 text-rose-700 dark:text-rose-300 border-rose-300 dark:border-rose-800 scale-105 shadow-sm"
                      : "bg-white/80 dark:bg-slate-900/80 border-slate-200/80 dark:border-slate-800 text-muted-foreground hover:text-rose-600 dark:hover:text-rose-400 hover:border-rose-200 dark:hover:border-rose-900/40"
                  )}
                >
                  <Icon className="size-3.5 text-rose-500 shrink-0" />
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-6 space-y-5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-bold bg-rose-50 text-rose-600 dark:bg-rose-950/40 dark:text-rose-400 border border-rose-200 dark:border-rose-900/40 shadow-xs">
              ...
              <div>
                <p className="text-xs font-mono font-bold uppercase tracking-wider text-muted-foreground mb-2.5">
                ...
                <div className="flex flex-wrap gap-2">
                  {curInt.apps.map((app, i) => (
                    <span
                      key={i}
                      className="px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200/80 dark:border-slate-700 text-xs font-semibold text-foreground flex items-center gap-1.5 shadow-xs hover:border-rose-300 transition-colors"
                    >
                      <Check className="size-3.5 text-rose-600 dark:text-rose-400 stroke-[3]" />
                      {app}
                    </span>
                  ))}
                </div>
            ...
            <div className="lg:col-span-6">
              ...
              >
                ...
                <div className="flex items-center justify-between border-b border-slate-200/80 dark:border-slate-800 pb-3">
                  ...
                  <span className="text-[10px] font-mono font-bold bg-rose-50 text-rose-600 dark:bg-rose-950/40 dark:text-rose-400 border border-rose-200 dark:border-rose-900/40 px-2.5 py-0.5 rounded-full shadow-xs">
                    Automated Relay
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3.5">
                    <div className="size-8 rounded-2xl bg-rose-500/15 text-rose-600 dark:text-rose-400 border border-rose-300 dark:border-rose-800 flex items-center justify-center shrink-0 mt-0.5 shadow-xs">
                      <Zap className="size-4" />
                    </div>
                    <div>
                      <p className="text-xs font-mono font-bold text-rose-600 dark:text-rose-400 uppercase">Live Technical Feature</p>
                      <p className="text-xs md:text-sm font-semibold text-foreground mt-0.5">{curInt.liveFeature}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3.5 pt-3 border-t border-slate-200/80 dark:border-slate-800">
                    ...
                    <div>
                      <p className="text-xs font-mono font-bold text-emerald-600 dark:text-emerald-400 uppercase">Measurable Business Impact</p>
                      <p className="text-xs md:text-sm font-bold text-rose-600 dark:text-rose-400 mt-0.5">{curInt.impact}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800 flex items-center justify-between">
                  <span className="text-[10px] font-mono text-muted-foreground uppercase font-bold">API Sync Latency</span>
        ...
        <div className="pt-16 border-t border-slate-200/60 dark:border-slate-800/60 mt-16 space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="inline-flex items-center gap-2 rounded-full bg-rose-50/80 dark:bg-rose-950/30 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50 shadow-xs">
              <DollarSign className="size-3.5 text-rose-500 animate-pulse" />
            ...
            <h3 className="text-2xl md:text-4xl font-serif font-normal text-foreground">
              Calculate your store's <span className="italic text-rose-600 dark:text-rose-400">monthly RTO & cart savings.</span>
            </h3>
          </div>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6">
              ...
              >
                <div className="flex items-center justify-between flex-wrap gap-2 border-b border-slate-200/80 dark:border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <Calculator className="size-4 text-rose-500" />
                    <label htmlFor="orders-slider" className="text-xs font-mono font-bold uppercase text-foreground">
                      Monthly Store Orders
                    </label>
                  </div>
                  <span className="text-base md:text-xl font-mono font-extrabold text-rose-600 dark:text-rose-400 bg-rose-50/90 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/40 px-3 py-1 rounded-full shadow-xs">
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="flex justify-between text-[10px] font-mono font-semibold text-muted-foreground pt-1">
                ...
                <div className="p-3 rounded-2xl bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200/60 dark:border-rose-900/30 text-[11px] font-mono text-muted-foreground flex items-center justify-between">
                  ...
                  <span className="font-bold text-rose-600 dark:text-rose-400">Assumed Recovery: 8%</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="lg:col-span-6 grid grid-cols-2 gap-4">
              <AnimatePresence mode="wait">
                ...
                >
                  <p className="text-[10px] font-mono text-muted-foreground uppercase font-bold">RTO Courier Savings</p>
                  <p className="text-xl md:text-2xl font-bold font-serif text-rose-600 dark:text-rose-400 mt-1">
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="p-5 rounded-3xl bg-white/95 dark:bg-slate-900/95 border border-rose-200 dark:border-rose-900/40 text-center shadow-lg backdrop-blur-xl"
                >
                  <p className="text-[10px] font-mono text-muted-foreground uppercase font-bold">Cart Revenue Recovered</p>
                  <p className="text-xl md:text-2xl font-bold font-serif text-rose-600 dark:text-rose-400 mt-1">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <p className="text-[11px] font-mono text-emerald-600 dark:text-emerald-400 font-bold uppercase tracking-wider">
                    ESTIMATED TOTAL MONTHLY BUSINESS IMPACT
                  </p>
                  <p className="text-2xl md:text-4xl font-extrabold font-serif text-emerald-600 dark:text-emerald-400 mt-1">
