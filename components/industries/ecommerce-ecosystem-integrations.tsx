    ...
    <section className="relative mx-auto w-full max-w-6xl px-4 py-16 md:px-6 md:py-24 border-t border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
      ...
      <div className="space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-2 rounded-full bg-rose-50/80 dark:bg-rose-950/30 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-rose-400 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50 shadow-xs">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-6 space-y-5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-bold bg-rose-50 text-rose-400 dark:bg-rose-950/40 dark:text-rose-400 border border-rose-200 dark:border-rose-900/40 shadow-xs">
            ...
            <div className="lg:col-span-6">
              ...
              >
                ...
                <div className="flex items-center justify-between border-b border-slate-200/80 dark:border-slate-800 pb-3">
                  ...
                  <span className="text-[10px] font-mono font-bold bg-rose-50 text-rose-400 dark:bg-rose-950/40 dark:text-rose-400 border border-rose-200 dark:border-rose-900/40 px-2.5 py-0.5 rounded-full shadow-xs">
                    Automated Relay
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <p className="text-xs font-mono font-bold text-rose-400 dark:text-rose-400 uppercase">Live Technical Feature</p>
                  ...
                  <div className="flex items-start gap-3.5 pt-3 border-t border-slate-200/80 dark:border-slate-800">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm font-bold text-rose-400 dark:text-rose-400 mt-0.5">{curInt.impact}</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-6">
              ...
              >
                <div className="flex items-center justify-between flex-wrap gap-2 border-b border-slate-200/80 dark:border-slate-800 pb-3">
                  ...
                  <span className="text-base md:text-xl font-mono font-extrabold text-rose-400 dark:text-rose-400 bg-rose-50/90 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/40 px-3 py-1 rounded-full shadow-xs">
                ...
                <div className="p-3 rounded-2xl bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200/60 dark:border-rose-900/30 text-[11px] font-mono text-muted-foreground flex items-center justify-between">
                  ...
                  <span className="font-bold text-rose-400 dark:text-rose-400">Assumed Recovery: 8%</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="lg:col-span-6 grid grid-cols-2 gap-4">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-xl md:text-2xl font-bold font-serif text-rose-400 dark:text-rose-400 mt-1">
