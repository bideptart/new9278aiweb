    ...
    <section className="relative overflow-hidden py-10 md:py-16">
      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-5xl mx-auto pt-2">
          ...
          <div className="lg:col-span-5 space-y-3 flex flex-col items-center [perspective:1000px]">
            {tiers.map((tr, idx) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "p-4 rounded-3xl transition-all duration-300 text-left flex items-center justify-between cursor-pointer border shadow-xs backdrop-blur-md relative overflow-hidden transform-gpu hover:-translate-y-0.5 [transform-style:preserve-3d] hover:[transform:rotateX(4deg)_rotateY(3deg)_translateY(-2px)]",
                    widths[idx],
                    isSelected
                      ? "bg-white dark:bg-slate-900 border-rose-300 dark:border-rose-700 shadow-md scale-105 ring-2 ring-rose-400/20"
                      : "bg-white/80 dark:bg-slate-900/80 border-slate-200/80 dark:border-slate-800 hover:border-rose-200 hover:bg-rose-50/40 hover:shadow-lg"
                  )}
                >
                  {/* Autoplay Progress Rail */}
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-rose-500/10">
          ...
          <div className="lg:col-span-7 flex justify-center [perspective:1000px]">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="w-full p-6 md:p-8 bg-gradient-to-br from-white via-rose-50/70 to-slate-100 dark:from-slate-900 dark:to-slate-950 border-2 border-rose-200/80 dark:border-rose-900/50 backdrop-blur-xl transition-transform duration-200 ease-out space-y-5"
              >
                {/* Header inside HUD */}
