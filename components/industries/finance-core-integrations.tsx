      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <h2 className="text-balance text-3xl font-serif font-normal leading-tight md:text-5xl text-foreground">
            Interconnected financial <span className="italic text-rose-400 dark:text-rose-400">clearing matrix.</span>
          </h2>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "bg-rose-500/15 text-rose-400 dark:text-rose-300 border-rose-300 dark:border-rose-800 shadow-md scale-105"
